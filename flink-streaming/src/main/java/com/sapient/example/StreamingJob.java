...
import com.sapient.example.utils.FilterStreamParser;
import com.sapient.example.utils.JoinProcessFunction;
import com.sapient.example.utils.WordStreamParser;
...
//		String socketHost = params.get("host");
        ...
        int portWordStream = 9000;
        int portFilterStream = 9001;
        int portSink = 9002;
        String stateDir = "file:///Users/ashtutej1/Documents/Sapient/projects/git/stateful/flink-streaming-example-master/rocksDb";
        ...
        // Create a word Tuple Stream of elements
        ...
        // Create a word Tuple Filter Stream to apply filter function
        ...
        // Create a Joined Stream of word Stream and Filter Stream and apply Process Function
        DataStream<Tuple2<String,Integer>> joinedStream = wordStream
                .connect(filterStream)
                .process(new JoinProcessFunction()).setParallelism(5).uid("join-Id").name("Co-JoinProcess")
                .keyBy(0)
                .window(SlidingProcessingTimeWindows.of(Time.seconds(1), Time.seconds(1)))
                .sum(1).name("Count Elements")
                .setParallelism(5);
